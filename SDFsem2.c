...
void sign()
{
    ...
    switch(op)
    {
        ...
        case 5: printf("Enter title\n");
              ...
              sign();
              break;
        case 6: printf("Enter school\n");
              scanf(" %[^\n]s",ob->school);
              getch();
              sign();
              break;
        case 7: printf("Enter nationality\n");
              scanf(" %[^\n]s",ob->nat);
              getch();
              sign();
              break;
        case 8: printf("Are you sure(y/n)?\n");
              scanf(" %c",&ch);
              if(ch=='y')
              {
...
void remark()
{
    ...
    switch(ob->score)
    {
        case 0: printf("Work hard - be stronger,swifter and smarter.");
                ob->zer++;
                break;
        case 10: printf("Better luck next time,may the force be with you.");
                ob->ten++;
                break;
        case 20: printf("Don't give up,you have the potential.");
                ob->twe++;
                break;
        case 30: printf("You can scale new heights,just believe.");
                ob->thi++;
                break;
        case 40: printf("So near yet so far,you are a good one buddy.");
                ob->fort++;
                break;
        case 50: printf("Perfect! We have the genius here.");
                ob->fif++;
                break;
    }
    printf("\n");
    ...
    else if(ch=='y')
    {
        ...
        switch(op)
        {
            ...
            case 3: printf("Enter password\n");
                   ...
                   info();
                   break;
            case 4: printf("Enter school\n");
                   scanf(" %[^\n]s",ob->school);
                   info();
                   break;
            case 5: printf("Enter nationality\n");
                   scanf(" %[^\n]s",ob->nat);
                   info();
                   break;
            case 6: printf("Enter title\n");
                   scanf(" %[^\n]s",ob->title);
                   info();
                   break;
            default: printf("wrong input");
